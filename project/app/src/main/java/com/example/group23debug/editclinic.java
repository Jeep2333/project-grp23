...
public class editclinic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editclinic);
        ...
        setupTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(editclinic.this,Timer.class);
        ...
        addservice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(editclinic.this,addsertocli.class);
        ...
        upgrade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //update name or role to firebase
                if(TextUtils.isEmpty(name.getText())||TextUtils.isEmpty(phone.getText())
                    ...
                    Toast.makeText(editclinic.this,"You are missing some thing. Try again.",Toast.LENGTH_SHORT).show();
                }else if(!CheckName(name.getText().toString())){
                    Toast.makeText(editclinic.this,"Incorrect name. Try again.",Toast.LENGTH_SHORT).show();
                    ...
                    ref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            Toast.makeText(editclinic.this,"Updated Successfully...",Toast.LENGTH_SHORT).show();

                            editclinic.this.finish();
                        }
        ...
        clinicList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent upgrade  = new Intent(editclinic.this,deleteservicefromclinic.class);
