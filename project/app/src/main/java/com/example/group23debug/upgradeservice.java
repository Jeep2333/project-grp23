...
public class upgradeservice extends AppCompatActivity {
    TextView name;
    EditText role;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upgradeservice);
                ...
                ref.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(upgradeservice.this,"Deleted successfully...",Toast.LENGTH_LONG).show();
                            upgradeservice.this.finish();
                        }else{
                            Toast.makeText(upgradeservice.this,"Error. Not deleted...",Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
        ...
        upgrade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //update name or role to firebase
                if(!CheckRole(role.getText().toString())){
                    Toast.makeText(upgradeservice.this,"Only doctor,nurse or staff is expected .",Toast.LENGTH_SHORT).show();
                }else if(!CheckName(name.getText().toString())){
                    Toast.makeText(upgradeservice.this,"Incorrect name. Try again.",Toast.LENGTH_SHORT).show();
                    ...
                    ref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            Toast.makeText(upgradeservice.this,"Updated Successfully...",Toast.LENGTH_SHORT).show();
