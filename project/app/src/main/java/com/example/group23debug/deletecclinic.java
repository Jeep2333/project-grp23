...
public class deletecclinic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deletecclinic);
                    ...
                    ref.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(deletecclinic.this,"Deleted successfully...",Toast.LENGTH_LONG).show();
                                deletecclinic.this.finish();
                            }else{
                                Toast.makeText(deletecclinic.this,"Error, Not deleted...",Toast.LENGTH_LONG).show();
                            }
                        }
                    });
