...
public class LoginPatientTest2 {
    @Rule
    ...
    public void LaunchSecondActivity() throws Exception {
        ...
        onView(withId(R.id.emailid)).perform(typeText("303"), closeSoftKeyboard());
        onView(withId(R.id.passwordid)).perform(typeText("rua"), closeSoftKeyboard());
